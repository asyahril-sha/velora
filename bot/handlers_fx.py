...
# ========== TAMBAHKAN IMPORT SESSION MANAGER ==========
from core.role_session import get_session_manager, sync_session_from_old
# ======================================================
...
def set_user_mode(user_id: int, mode: str, active_role: Optional[str] = None):
    ...
    # ========== TAMBAHKAN: Sync ke session manager ==========
    session_manager = get_session_manager()
    session_manager.sync_from_old_system(user_id, mode, active_role)
    # ========================================================
...
def clear_user_mode(user_id: int):
    ...
    # ========== TAMBAHKAN: Clear session di session manager ==========
    session_manager = get_session_manager()
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ========== TAMBAHKAN: Update session activity ==========
    session_manager = get_session_manager()
...
async def nova_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ========== TAMBAHKAN: Switch ke Nova di session manager ==========
    session_manager.switch_to_nova(user_id)
    # ==================================================================
...
async def status_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ========== TAMBAHKAN: Dapatkan session stats ==========
...
║   Active Roles: {session_stats.get('active_roles', {})}
╠══════════════════════════════════════════════════════════════╣
║ ORCHESTRATOR STATS:
...
async def flashback_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Cek apakah Nova aktif (dari session manager)
    if not session_manager.is_nova_active(user_id):
        await update.message.reply_text(
...
async def roleplay_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ========== TAMBAHKAN: Switch ke roleplay di session manager ==========
    session_manager.switch_to_roleplay(user_id)
    # ======================================================================
...
async def role_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ========== TAMBAHKAN: Switch ke role di session manager ==========
    session_manager.switch_to_role(user_id, role_id)
    # ==================================================================
...
async def back_to_nova(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ========== TAMBAHKAN: Clear session dan switch ke Nova ==========
    session_manager.clear_session(user_id)
    session_manager.switch_to_nova(user_id)
    # ==================================================================
